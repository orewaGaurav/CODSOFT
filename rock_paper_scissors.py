...
def new():
    ...
    def rules(a):
        ...
        reset=Button(root,text="New Game",bg="black",fg="white",font=("arial",30),command=new)
    ...
    label=Label(root,text="Enter your name",bg="black",fg="white",font=("arial",30))
    label.grid(row=1,column=1,pady=20)
    entry=Entry(root,font=("arial",30),bg="black",fg="white")
    entry.grid(row=2,column=1,pady=50)
    start=Button(root,text="Start",bg="black",fg="white",font=("arial",30),command=st)
    start.grid(row=3,column=1)
    label1=Label(root,text="",font=("arial",30),bg="black",fg="white")
    label1.grid(row=4,column=1,pady=10)
    choice1=Button(root,text="Rock",bg="black",fg="white",font=("arial",30),command=choice_1,height=4,width=8)
    choice1.grid(row=5,column=0,padx=10,pady=50)
    choice2=Button(root,text="Paper",bg="black",fg="white",font=("arial",30),command=choice_2,height=4,width=8)
    choice2.grid(row=5,column=1,padx=10,pady=50)
    choice3=Button(root,text="Scissors",bg="black",fg="white",font=("arial",30),command=choice_3,height=4,width=8)
    choice3.grid(row=5,column=2,padx=10,pady=50)
    label2=Label(root,text="",bg="black",fg="white",font=("arial",30))
